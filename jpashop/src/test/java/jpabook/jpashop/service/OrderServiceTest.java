...
// 사실 좋은 테스트는 스프링과 DB에 의존하지 않고 순수하게 메서드들을 단위 테스트를 통해 검증하는 것이 좋다.
...
public class OrderServiceTest {
    ...
    public void 상품주문() throws Exception {
        ...
        // 메시지(테스트가 실패했을 때 출력되는 메시지), 기대값, 실제값
    ...
    public void 주문취소() throws Exception {
        ...
        assertEquals("주문이 취소된 상품은 그만큼 재고가 증가해야 한다.", 8 + orderCount, item.getStockQuantity());
    }
